                  ...
                  <div className="md:col-span-3">
                    ...
                    <div className="flex justify-end gap-2 flex-wrap">
                      ...
                      <button
                        ...
                        className="bg-DeleteCue hover:bg-Pause active:bg-Stop active:scale-95 text-white w-8 h-8 rounded flex items-center justify-center transition duration-200"
                        title="Delete cue"
                      >
                        ✕
                      </button>
